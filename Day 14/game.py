...
def game():
    ...
    while not game_end:
        ...
        print(
            f"Compare A: {random_person_1['name']}, a {random_person_1['description']}, from {random_person_1['country']}.")

        print(art.vs)

        random_person_2 = random.choice(data.data)
        print(
            f"Against B: {random_person_2['name']}, a {random_person_2['description']}, from {random_person_2['country']}.")
